...
public class StoreService {
	...
	public StoreService() throws Exception{
		...
		String[] fileArr = {
				"C:\\zzz\\store\\store1.txt",
				"C:\\zzz\\store\\store2.txt",
				"C:\\zzz\\store\\store3.txt"};
...
//				System.out.println(Arrays.toString(arr));
	...
	public List<StoreVO> getNear(List<StoreVO> kList, double lat, double lng){
		
		Collections.sort(kList,(s1,s2)->{
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(obj.getNearKind(new String[]{"k"} ,37.569340, 126.983665));
